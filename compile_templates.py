...
def compile_templates(argv=None):
    ...
    from myfilters import do_currencyfy, do_statusfy, do_pricefy, do_addressify, do_descriptify, do_headlinify, do_slugify, do_operationfy, do_totalareafy, do_expensasfy, do_add_days,  do_ownerify, do_oper_labelify, do_email_to_png
